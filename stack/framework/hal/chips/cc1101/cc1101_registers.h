...
// IOCFGx.GDOx_CFG
#define RADIO_GDO2_VALUE                0x29        	// IOCFG2.GDO2_CFG - chip ready
...
#define RADIO_MDMCFG4_NORMAL_RATE RADIO_MDMCFG4_CHANBW_E(0x02) | RADIO_MDMCFG4_CHANBW_M(0x00) | RADIO_MDMCFG4_DRATE_E(0x0B) // MDMCFG4   Modem configuration.
